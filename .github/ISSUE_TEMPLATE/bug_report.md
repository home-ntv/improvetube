...
_**1.**  Thanks for coming! Before submitting please check if the issue has already been reported ever. With  [GitHub's issue search (use this link)](https://github.com/ImproveTube/ImproveTube/issues?q=)  (else removing "is:issue is:open" from the standard search)_
...
⚬ ImproveTube Version:    <!--  [e.g. 4.1.1 You can find it at the ⋮ icon>settings>version]   -->
⚬ Browser:    <!--  [e.g.  Chromium 83.0.4103.116  / Firefox / Safari / ...] -->
⚬ Settings:   <!--  Maybe Attach exported settings  `(ImproveTube -> Settings -> Backup & reset -> Export settings)`  -->
